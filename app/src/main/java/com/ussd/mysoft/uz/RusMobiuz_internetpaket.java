...
public class RusMobiuz_internetpaket extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rus_mobiuz_internetpaket);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.mobiuz_paket300:
                ...
                if (ContextCompat.checkSelfPermission(RusMobiuz_internetpaket.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                    ActivityCompat.requestPermissions(RusMobiuz_internetpaket.this, new String[]{Manifest.permission.CALL_PHONE},100);
                }
                else
                {
