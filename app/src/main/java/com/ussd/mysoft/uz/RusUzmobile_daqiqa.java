...
public class RusUzmobile_daqiqa extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rus_uzmobile_daqiqa);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.uzmobile_minut100:
                ...
                if (ContextCompat.checkSelfPermission(RusUzmobile_daqiqa.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                    ActivityCompat.requestPermissions(RusUzmobile_daqiqa.this, new String[]{Manifest.permission.CALL_PHONE},100);
                }
                else
                {
