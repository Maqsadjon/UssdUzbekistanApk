...
public class Beeline_internetpaket extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_beeline_internetpaket);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.beeline_internet1000:
                ...
                if (ContextCompat.checkSelfPermission(Beeline_internetpaket.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                    ActivityCompat.requestPermissions(Beeline_internetpaket.this, new String[]{Manifest.permission.CALL_PHONE},100);
                }
                else
                {
