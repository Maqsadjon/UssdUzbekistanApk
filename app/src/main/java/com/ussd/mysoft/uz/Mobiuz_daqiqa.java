...
public class Mobiuz_daqiqa extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mobiuz_daqiqa);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.mobiuz_daq60:
                ...
                if (ContextCompat.checkSelfPermission(Mobiuz_daqiqa.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                    ActivityCompat.requestPermissions(Mobiuz_daqiqa.this, new String[]{Manifest.permission.CALL_PHONE},100);
                }
                else
                {
