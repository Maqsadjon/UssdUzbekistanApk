...
public class Mobiuz_ussd extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mobiuz_ussd);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.mobiuz_balans:
                ...
                if (ContextCompat.checkSelfPermission(Mobiuz_ussd.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                    ActivityCompat.requestPermissions(Mobiuz_ussd.this, new String[]{Manifest.permission.CALL_PHONE},100);
                }
                else
                {
