...
public class Ucell_tarifreja extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ucell_tarifreja);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.ucell_yaxshikayifyat:
                ...
                if (ContextCompat.checkSelfPermission(Ucell_tarifreja.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                    ActivityCompat.requestPermissions(Ucell_tarifreja.this, new String[]{Manifest.permission.CALL_PHONE},100);
                }
                else
                {
