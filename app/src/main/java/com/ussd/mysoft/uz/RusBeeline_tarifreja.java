...
public class RusBeeline_tarifreja extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rus_beeline_tarifreja);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.beeline_tarifzor2:
                ...
                if (ContextCompat.checkSelfPermission(RusBeeline_tarifreja.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                    ActivityCompat.requestPermissions(RusBeeline_tarifreja.this, new String[]{Manifest.permission.CALL_PHONE},100);
                }
                else
                {
