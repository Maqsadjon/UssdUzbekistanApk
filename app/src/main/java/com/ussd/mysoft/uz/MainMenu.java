...
public class MainMenu extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.ussd:
                startActivity(new Intent(MainMenu.this,Beeline_ussd.class));
                break;
            case R.id.smsbil:

                startActivity(new Intent(MainMenu.this,Beeline_sms.class));
                break;
            case R.id.internetpaket:

                startActivity(new Intent(MainMenu.this,Beeline_internetpaket.class));
                break;
            case R.id.beelidedaqiqa:

                startActivity(new Intent(MainMenu.this,Beeline_daqiqa.class));
                break;
            case R.id.tarifrejalar:

                startActivity(new Intent(MainMenu.this,Beeline_tarifreja.class));
                break;
            case R.id.beelinexizmatlar:

                startActivity(new Intent(MainMenu.this,Beeline_xizmatlar.class));
                break;
