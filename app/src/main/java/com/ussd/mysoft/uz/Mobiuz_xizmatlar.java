...
public class Mobiuz_xizmatlar extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mobiuz_xizmatlar);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.mobiuz_konferensiya:
                ...
                if (ContextCompat.checkSelfPermission(Mobiuz_xizmatlar.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                    ActivityCompat.requestPermissions(Mobiuz_xizmatlar.this, new String[]{Manifest.permission.CALL_PHONE},100);
                }
                else
                {
