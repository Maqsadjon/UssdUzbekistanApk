...
public class RusUzmobileMenu extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rus_uzmobile_menu);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.ussd_uzmobile:
                ...
                startActivity(new Intent(RusUzmobileMenu.this,RusUzmobile_ussd.class));

                break;
            case R.id.smsuzmobile:

                startActivity(new Intent(RusUzmobileMenu.this,RusUzmobile_sms.class));
                break;
            case R.id.uzmobile_internetpaket:

                startActivity(new Intent(RusUzmobileMenu.this,RusUzmobile_internetpaket.class));
                break;
            case R.id.uzmobiledaqiqa:

                startActivity(new Intent(RusUzmobileMenu.this,RusUzmobile_daqiqa.class));
                break;
            case R.id.uzmobile_tarifrejalar:

                startActivity(new Intent(RusUzmobileMenu.this,RusUzmobile_tarifreja.class));
                break;
            case R.id.uzmobilexizmatlar:

                startActivity(new Intent(RusUzmobileMenu.this,RusUzmobile_xizmatlar.class));
                break;
