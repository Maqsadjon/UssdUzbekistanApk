...
public class Uzmobile_xizmatlar extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_uzmobile_xizmatlar);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.uzmobile_restart:
                ...
                if (ContextCompat.checkSelfPermission(Uzmobile_xizmatlar.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                    ActivityCompat.requestPermissions(Uzmobile_xizmatlar.this, new String[]{Manifest.permission.CALL_PHONE},100);
                }
                else
                {
