...
public class RusUcell_sms extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rus_ucell_sms);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.ucell_50sms:
                ...
                if (ContextCompat.checkSelfPermission(RusUcell_sms.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                    ActivityCompat.requestPermissions(RusUcell_sms.this, new String[]{Manifest.permission.CALL_PHONE},100);
                }
                else
                {
