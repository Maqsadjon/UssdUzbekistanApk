...
public class Ucell_xizmatlar extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ucell_xizmatlar);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.ucell_raqamyashirish:
                ...
                if (ContextCompat.checkSelfPermission(Ucell_xizmatlar.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                    ActivityCompat.requestPermissions(Ucell_xizmatlar.this, new String[]{Manifest.permission.CALL_PHONE},100);
                }
                else
                {
