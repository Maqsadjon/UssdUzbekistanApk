...
public class RusUzmobile_sms extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rus_uzmobile_sms);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.uzmobile_sms50:
                ...
                if (ContextCompat.checkSelfPermission(RusUzmobile_sms.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                    ActivityCompat.requestPermissions(RusUzmobile_sms.this, new String[]{Manifest.permission.CALL_PHONE},100);
                }
                else
                {
