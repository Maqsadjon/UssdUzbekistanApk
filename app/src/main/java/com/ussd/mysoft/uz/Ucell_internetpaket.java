...
public class Ucell_internetpaket extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ucell_internetpaket);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.ucell_1gb:
                ...
                if (ContextCompat.checkSelfPermission(Ucell_internetpaket.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                    ActivityCompat.requestPermissions(Ucell_internetpaket.this, new String[]{Manifest.permission.CALL_PHONE},100);
                }
                else
                {
