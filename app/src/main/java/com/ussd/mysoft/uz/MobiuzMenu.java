...
public class MobiuzMenu extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mobiuz_menu);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.ussd_ums:
                ...
                startActivity(new Intent(MobiuzMenu.this,Mobiuz_ussd.class));

                break;
            case R.id.smsums:

                startActivity(new Intent(MobiuzMenu.this,Mobiuz_sms.class));
                break;
            case R.id.ums_internetpaket:

                startActivity(new Intent(MobiuzMenu.this,Mobiuz_internetpaket.class));
                break;
            case R.id.umsdaqiqa:

                startActivity(new Intent(MobiuzMenu.this,Mobiuz_daqiqa.class));
                break;
            case R.id.ums_tarifrejalar:

                startActivity(new Intent(MobiuzMenu.this,Mobiuz_tarifreja.class));
                break;
            case R.id.umsxizmatlar:

                startActivity(new Intent(MobiuzMenu.this,Mobiuz_xizmatlar.class));
                break;
