...
public class RusUzmobile_tarifreja extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rus_uzmobile_tarifreja);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.uzmobile_street:
                ...
                if (ContextCompat.checkSelfPermission(RusUzmobile_tarifreja.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                    ActivityCompat.requestPermissions(RusUzmobile_tarifreja.this, new String[]{Manifest.permission.CALL_PHONE},100);
                }
                else
                {
