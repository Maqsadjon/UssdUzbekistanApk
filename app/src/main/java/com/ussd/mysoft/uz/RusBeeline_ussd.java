...
public class RusBeeline_ussd extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rus_beeline_ussd);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.beeline_balans:
                ...
                if (ContextCompat.checkSelfPermission(RusBeeline_ussd.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                    ActivityCompat.requestPermissions(RusBeeline_ussd.this, new String[]{Manifest.permission.CALL_PHONE},100);
                }
                else
                {
