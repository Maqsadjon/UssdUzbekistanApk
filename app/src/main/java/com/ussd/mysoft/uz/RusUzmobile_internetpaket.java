...
public class RusUzmobile_internetpaket extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rus_uzmobile_internetpaket);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.uzmobile_1000:
                ...
                if (ContextCompat.checkSelfPermission(RusUzmobile_internetpaket.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                    ActivityCompat.requestPermissions(RusUzmobile_internetpaket.this, new String[]{Manifest.permission.CALL_PHONE},100);
                }
                else
                {
