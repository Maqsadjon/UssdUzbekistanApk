...
public class Ucell_ussd extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ucell_ussd);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.ucell_balans:
                ...
                if (ContextCompat.checkSelfPermission(Ucell_ussd.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                    ActivityCompat.requestPermissions(Ucell_ussd.this, new String[]{Manifest.permission.CALL_PHONE},100);
                }
                else
                {
