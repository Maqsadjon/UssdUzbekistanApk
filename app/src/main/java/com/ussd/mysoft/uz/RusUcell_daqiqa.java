...
public class RusUcell_daqiqa extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rus_ucell_daqiqa);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.ucell_200daq:
                ...
                if (ContextCompat.checkSelfPermission(RusUcell_daqiqa.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                    ActivityCompat.requestPermissions(RusUcell_daqiqa.this, new String[]{Manifest.permission.CALL_PHONE},100);
                }
                else
                {
