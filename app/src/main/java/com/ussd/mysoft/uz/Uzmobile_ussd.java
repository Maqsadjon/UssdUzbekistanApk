...
public class Uzmobile_ussd extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_uzmobile_ussd);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.uzmobile_balans:
                ...
                if (ContextCompat.checkSelfPermission(Uzmobile_ussd.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                    ActivityCompat.requestPermissions(Uzmobile_ussd.this, new String[]{Manifest.permission.CALL_PHONE},100);
                }
                else
                {
