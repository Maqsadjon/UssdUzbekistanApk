...
public class RusBeeline_daqiqa extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rus_beeline_daqiqa);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.beeline_daqextra200:
                ...
                if (ContextCompat.checkSelfPermission(RusBeeline_daqiqa.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                    ActivityCompat.requestPermissions(RusBeeline_daqiqa.this, new String[]{Manifest.permission.CALL_PHONE},100);
                }
                else
                {
