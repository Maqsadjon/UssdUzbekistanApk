...
public class RusBeeline_sms extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rus_beeline_sms);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.beeline_sms20:
                ...
                if (ContextCompat.checkSelfPermission(RusBeeline_sms.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                    ActivityCompat.requestPermissions(RusBeeline_sms.this, new String[]{Manifest.permission.CALL_PHONE},100);
                }
                else
                {
