...
public class RusBeeline_xizmatlar extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rus_beeline_xizmatlar);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.beeline_perezagruzka:
                ...
                if (ContextCompat.checkSelfPermission(RusBeeline_xizmatlar.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                    ActivityCompat.requestPermissions(RusBeeline_xizmatlar.this, new String[]{Manifest.permission.CALL_PHONE},100);
                }
                else
                {
