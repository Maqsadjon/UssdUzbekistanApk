...
public class Mobiuz_tarifreja extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mobiuz_tarifreja);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.mobiuz_chillalite:
                ...
                if (ContextCompat.checkSelfPermission(Mobiuz_tarifreja.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                    ActivityCompat.requestPermissions(Mobiuz_tarifreja.this, new String[]{Manifest.permission.CALL_PHONE},100);
                }
                else
                {
