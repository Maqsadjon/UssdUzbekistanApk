...
public class Mobiuz_sms extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mobiuz_sms);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.mobiuz_sms100:
                ...
                if (ContextCompat.checkSelfPermission(Mobiuz_sms.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                    ActivityCompat.requestPermissions(Mobiuz_sms.this, new String[]{Manifest.permission.CALL_PHONE},100);
                }
                else
                {
